...
### C. Interactions (JS)
1. **int_scroll_reveal** (animation): Elements fade up/slide in as user scrolls (Logic: intersection-observer)
...
### `index.html` (Home)
-   **Hero:** Headline "Scale Your Business with [Product Name]", Subhead "Seamlessly integrate with your favorite tools. No coding required.".
